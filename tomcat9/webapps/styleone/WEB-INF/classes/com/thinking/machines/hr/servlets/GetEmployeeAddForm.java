...
pw.println("valid= false;");
pw.println("firstInvalidComponent=frm.designationCode;");
pw.println("}");
...
pw.println("dateOfBirthErrorSection.innerHTML='Select Date';");
pw.println("valid= false;");
...
pw.println("basicSalaryErrorSection.innerHTML='Required';");
pw.println("valid= false;");
pw.println("firstInvalidComponent=frm.basicSalary;");
pw.println("}");
pw.println("else{");
pw.println("var v='0123456789.';");
pw.println("var e=0;");
pw.println("var basicSalaryValid=true;");
...
pw.println("panNumberErrorSection.innerHTML='Required';");
pw.println("frm.panNumber.focus();");
pw.println("valid= false;");
...
pw.println("aadharCardNumberErrorSection.innerHTML='Required';");
pw.println("frm.aadharCardNumber.focus();");
pw.println("valid= false;");
...
pw.println("<option value='-1'>&lt;Select&gt</option>");
...
pw.println("<td><input type='checkbox' name='isIndian' id='isIndian'></td>");
pw.println("</tr>");
pw.println("<tr>");
...
pw.println("<td><input type='text' id='panNumber' name='panNumber' maxlength=''> ");
pw.println("<span id='panNumberErrorSection' style='color:red'></span>");
pw.println("  </td>");
pw.println("</tr>");
pw.println("<tr>");
pw.println("<td>Aadhar card Number</td>");
pw.println("<td><input type='text' id='aadharCardNumber' name='aadharCardNumber' maxlength=''> ");
