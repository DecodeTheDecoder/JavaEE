...
pw.println("Designation <input type='label' name='title' id='title' maxlength='35' size='36' value='"+title+"'>");
pw.println("<span id='titleErrorSection' style='color:red'></span><br>");

pw.println("<button type='submit'> Delete</button>");


pw.println("<button type='button' onclick='cancelDeleting()'> Cancel </button>");
pw.println("</form>");
